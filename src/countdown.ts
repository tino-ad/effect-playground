 ...
 * Note: the first value is emitted after the first interval tick.
 */
export const countdown = (start: number, options: CountdownOptions = {}): Stream.Stream<never, never, number> => {
